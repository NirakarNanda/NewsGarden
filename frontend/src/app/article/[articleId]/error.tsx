...
/**
 * Catches render/data errors in the article route. Offers a real retry
 * (reset); never renders a fake article.
 */
export default function ArticleError({
  ...
  return (
    <div className="min-h-screen bg-[#0b0f1a]">
      ...
      <ErrorState
        title="This article hit a snag"
        detail="Something went wrong while rendering it. The backend may be unreachable, or the article data may be incomplete."
